...
void janus_streaming_create_session(janus_plugin_session *handle, int *error)
{
	...
	janus_mutex_lock(&sessions_mutex);
	JANUS_LOG(LOG_INFO, "Created new streaming session!\n");
...
struct janus_plugin_result *janus_streaming_handle_message(janus_plugin_session *handle, char *transaction, json_t *message, json_t *jsep)
{
	...
	else if (!strcasecmp(request_text, "acceptanswer") || !strcasecmp(request_text, "acceptoffer") || !strcasecmp(request_text, "startstream") || !strcasecmp(request_text, "stopstream") || !strcasecmp(request_text, "connect") || !strcasecmp(request_text, "watch") || !strcasecmp(request_text, "start") || !strcasecmp(request_text, "pause") || !strcasecmp(request_text, "stop") || !strcasecmp(request_text, "configure") || !strcasecmp(request_text, "switch"))
	{
